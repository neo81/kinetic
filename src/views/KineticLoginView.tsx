...
export const KineticLoginView = ({ onLogin }: { onLogin: () => void }) => (
  <PageShell
    activeView="login"
    setView={() => undefined}
    showFooter={false}
    showSettings={false}
    showProfile={false}
    contentClassName="max-w-6xl px-0 pb-0 pt-20 sm:px-0"
  >
    <div className="relative overflow-hidden rounded-b-[2rem] border-b border-white/6 md:rounded-[2rem] md:border md:border-white/6 md:bg-surface-container-low/35 md:shadow-[0_30px_90px_rgba(0,0,0,0.36)]">
      ...
      <div className="relative z-10 grid min-h-[calc(100dvh-5rem)] grid-cols-1 md:min-h-[calc(100dvh-8rem)] md:grid-cols-[minmax(0,1.15fr)_minmax(24rem,0.85fr)]">
        <section className="relative min-h-[20rem] overflow-hidden md:min-h-full">
          <img
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_18%,rgba(212,255,0,0.16),transparent_24%)]"></div>
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 pb-8 sm:p-8 md:inset-0 md:flex md:flex-col md:justify-end md:p-12 lg:p-16">
            <div className="max-w-xl">
              ...
              <p className="mt-4 max-w-md text-sm leading-relaxed text-on-surface-variant sm:text-[0.95rem] md:text-base">
                Plataforma PWA de entrenamiento con foco en precision, volumen y seguimiento de cada sesion desde cualquier dispositivo.
              </p>
            </div>
          </div>
        </section>

        <section className="relative z-20 flex items-start justify-center rounded-t-[2rem] bg-surface-container-low px-5 pb-8 pt-8 sm:px-6 md:min-h-full md:items-center md:rounded-none md:border-l md:border-white/6 md:bg-surface-container-low/92 md:px-8 md:py-10 lg:px-10">
          <div className="w-full max-w-md">
            <div className="mb-8">
              <div className="mb-2 font-headline text-[2rem] font-semibold uppercase tracking-[0.05em] text-primary sm:text-[2.2rem]">Kinetic Volt</div>
            ...
            <button
              onClick={onLogin}
              className="control-shell mb-6 flex h-15 w-full items-center justify-center gap-3 rounded-[1.15rem] px-5 text-on-surface transition-all duration-200 hover:bg-surface-container-highest active:scale-[0.985] sm:h-16"
            >
            ...
            >
              <div>
                ...
                <div className="control-shell rounded-[1.15rem]">
                  <input
                    ...
                    placeholder="correo@kineticvolt.com"
                    type="email"
                  />
                </div>
              </div>
              ...
              <div>
                <div className="mb-2 flex items-center justify-between gap-3">
                  ...
                  <button
                    type="button"
                    className="font-headline text-[1.1rem] font-semibold uppercase tracking-[0.12em] text-primary transition-colors hover:text-primary/80 sm:text-[1.25rem]"
                  >
                    Recuperar
                  </button>
                </div>
              ...
              <label className="flex items-center gap-3 pt-1 text-[0.92rem] text-on-surface-variant">
                <input
                  type="checkbox"
                  className="h-5 w-5 appearance-none rounded-[0.35rem] border border-white/10 bg-surface-container-highest checked:border-primary checked:bg-primary"
                />
                <span>Mantener sesion activa durante 30 dias</span>
              </label>

              <button
                type="submit"
                className="neon-button mt-2 h-15 w-full rounded-[1.15rem] font-headline text-[1.4rem] font-semibold uppercase tracking-[0.16em] transition-all active:scale-[0.985] sm:h-16 sm:text-[1.55rem]"
              >
                Iniciar sesion
              </button>
            </form>
            ...
            <div className="mt-10 grid grid-cols-2 gap-4 border-t border-white/6 pt-6 text-center sm:gap-6 sm:pt-8">
              ...
              <div>
                <div className="mb-2 text-[0.7rem] font-medium uppercase tracking-[0.2em] text-on-surface-variant">Version</div>
