...
- Verificacion:
  - La linea base queda en 120 pruebas aprobadas, TypeScript sin errores y build correcto. El build PWA genera el service worker y precarga 66 recursos (aproximadamente 3,86 MiB, incluidas las fuentes locales); Progreso queda aislado en un bloque diferido de aproximadamente 19 kB y no reintroduce advertencias por tamano de chunks.
