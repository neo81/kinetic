...
- **Navegación inferior Liquid Glass**: La barra flotante reúne Inicio, Rutinas, Motor, Historial y Perfil en cinco accesos sin etiquetas visibles. Al tocar, la lente conserva el desplazamiento horizontal compacto; al arrastrarla aumenta y se asienta de forma progresiva. La superficie aproxima la refracción mediante desenfoque, saturación y reflejos, conserva una alternativa sólida para navegadores sin desenfoque de fondo y, en tema claro, usa un solo borde sin sombra externa ni capa interna inferior.
- **Burbuja activa en tema claro**: El indicador seleccionado elimina el arco gris inferior de su capa decorativa interna y conserva el contorno de color.
